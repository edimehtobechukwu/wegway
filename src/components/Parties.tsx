...
export function Parties() {
  ...
  const steps = [
    {
      number: "01",
      title: t('parties.steps.01.title'),
      text: t('parties.steps.01.text')
    },
    {
      number: "02",
      title: t('parties.steps.02.title'),
      text: t('parties.steps.02.text')
    },
    {
      number: "03",
      title: t('parties.steps.03.title'),
      text: t('parties.steps.03.text')
    },
    {
      number: "04",
      title: t('parties.steps.04.title'),
      text: t('parties.steps.04.text')
    }
  ];
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
          <ScrollReveal>
            ...
            <h2 className="font-['Oswald',sans-serif] font-bold text-[#1a4d2e] text-[32px] md:text-[48px] leading-tight uppercase">
              {t('parties.title_part1')} <span className="text-[#e87c46]">WEG WAY</span> {t('parties.title_part2')}
            </h2>
          </ScrollReveal>
